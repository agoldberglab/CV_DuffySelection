...
ms_simulations <- read.table("~/home/CV_DuffySelection/datasets/CV_ABC_additive.txt", header=TRUE)
...
tols=c(.01,.05), method="neuralnet", sizenet=2)

save(cv.nn.ms_5stats_2_tols, file = "CV_ms-nn_5stats_size2.RData")
