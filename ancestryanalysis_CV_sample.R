...
tract_file <- paste0(pattern_match[,1], "tractlengths_sample.txt")
...
iDAT_score <- log(P2_iDAT/P1_iDAT)

cat(seed, s, m, bene_rank, bene_prop, mean_globalancestry, var_prop, var_prop_10Mb,
    q95_prop, median_tractlength, mean_tractlength, var_tractlength, q95_tract,
    length_75_prop, length_95_prop, anc_switches, global_75_prop, paste0(iDAT_score, "\n"), sep="\t")
