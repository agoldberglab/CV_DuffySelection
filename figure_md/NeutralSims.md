...
### Alternate genetic maps, sample of 172 individuals

``` r
cv_exp_10000_singlepulse_sample$model <- "impute2 map"

AA_rates_cv_exp_10000_singlepulse_sample <- read.table(file="AA_rates_CV_neutral_exp-05-10000_single-pulse_SAMPLE.txt", header=TRUE)
AA_rates_cv_exp_10000_singlepulse_sample$model <- "AA map"

IBS_rates_cv_exp_10000_singlepulse_sample <- read.table(file="IBS_rates_CV_neutral_exp-05-10000_single-pulse_SAMPLE.txt", header=TRUE)
IBS_rates_cv_exp_10000_singlepulse_sample$model <- "IBS map"

GWD_rates_cv_exp_10000_singlepulse_sample <- read.table(file="GWD_rates_CV_neutral_exp-05-10000_single-pulse_SAMPLE.txt", header=TRUE)
GWD_rates_cv_exp_10000_singlepulse_sample$model <- "GWD map"
```

``` r
bene_prop_plot <- ggplot() +
  geom_density(mapping=aes(x=cv_exp_10000_singlepulse_sample$bene_prop, color = cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=AA_rates_cv_exp_10000_singlepulse_sample$bene_prop, color = AA_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=GWD_rates_cv_exp_10000_singlepulse_sample$bene_prop, color = GWD_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=IBS_rates_cv_exp_10000_singlepulse_sample$bene_prop, color = IBS_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_vline(xintercept = CV_stats$bene_prop[1], color = "red") +
  labs(x="DARC ancestry proportion", linetype = "migration") +
  theme_classic() +
  theme(aspect.ratio = 1)

median_tract_plot <- ggplot() +
 geom_density(mapping=aes(x=cv_exp_10000_singlepulse_sample$median_tract, color = cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=AA_rates_cv_exp_10000_singlepulse_sample$median_tract, color = AA_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=GWD_rates_cv_exp_10000_singlepulse_sample$median_tract, color = GWD_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=IBS_rates_cv_exp_10000_singlepulse_sample$median_tract, color = IBS_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_vline(xintercept = CV_stats$median_tract[1], color = "red") +
  labs(x="median tract length", linetype = "migration") +
  theme_classic() +
  theme(aspect.ratio = 1)

mean_tract_plot <- ggplot() +
  geom_density(mapping=aes(x=cv_exp_10000_singlepulse_sample$mean_tract, color = cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=AA_rates_cv_exp_10000_singlepulse_sample$mean_tract, color = AA_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=GWD_rates_cv_exp_10000_singlepulse_sample$mean_tract, color = GWD_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=IBS_rates_cv_exp_10000_singlepulse_sample$mean_tract, color = IBS_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_vline(xintercept = CV_stats$mean_tract[1], color = "red") +
  labs(x="mean tract length", linetype = "migration") +
  theme_classic() +
  theme(aspect.ratio = 1)

var_prop_plot <- ggplot() +
  geom_density(mapping=aes(x=cv_exp_10000_singlepulse_sample$var_prop, color = cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=AA_rates_cv_exp_10000_singlepulse_sample$var_prop, color = AA_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=GWD_rates_cv_exp_10000_singlepulse_sample$var_prop, color = GWD_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=IBS_rates_cv_exp_10000_singlepulse_sample$var_prop, color = IBS_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_vline(xintercept = CV_stats$var_prop[1], color = "red") +
  labs(x="variance in ancestry proportion", linetype = "migration") +
  theme_classic() +
  theme(aspect.ratio = 1)

iDAT_score_plot <- ggplot() +
  geom_density(mapping=aes(x=cv_exp_10000_singlepulse_sample$iDAT_score, color = cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=AA_rates_cv_exp_10000_singlepulse_sample$iDAT_score, color = AA_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=GWD_rates_cv_exp_10000_singlepulse_sample$iDAT_score, color = GWD_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_density(mapping=aes(x=IBS_rates_cv_exp_10000_singlepulse_sample$iDAT_score, color = IBS_rates_cv_exp_10000_singlepulse_sample$model)) +
  geom_vline(xintercept = CV_stats$iDAT_score[1], color = "red") +
  labs(x="DARC iDAT score", linetype = "migration") +
  theme_classic() +
  theme(aspect.ratio = 1)
...
![](NeutralSims_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
