...
chrom_1_length <- 249904549.0
chrom_2_length <- 243199372.0
whole_genome_length <- chrom_1_length + chrom_2_length
...
mean_restgenome_ancestry <- sum(ancestry_prop_restgenome$P1AncestryProportion*ancestry_prop_restgenome$interval/chrom_2_length)
