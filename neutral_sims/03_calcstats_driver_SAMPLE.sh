...
sbatch -a 1-100 ~/home/CV_DuffySelection/neutral_sims/calcstats_const-Ne_SAMPLE.sh 
sbatch -a 1-100 ~/home/CV_DuffySelection/neutral_sims/calcstats_exp-Ne_SAMPLE.sh
